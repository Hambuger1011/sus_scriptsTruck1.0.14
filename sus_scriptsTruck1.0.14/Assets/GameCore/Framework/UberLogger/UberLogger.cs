...
namespace UberLogger
{
    ...
    public class LogInfo
    {
        ...
        public LogType logType
        {
            get
            {
                ...
                {
                    case UberLogger.LogSeverity.Warning:
                        type = LogType.Warning;
                        break;
                    case UberLogger.LogSeverity.Error:
                        if (this.isException)
                        {
        ...
        private string m_simpleMessage = null;
        ...
        public string GetSimpleMessage()
        {
            ...
            if(m_simpleMessage == null)
            {
                if (this.Message.Length > 1000)
                {
                    m_simpleMessage = this.Message.Substring(0, 1000)+"\n<====more===>\n";
                }else
                {
                    m_simpleMessage = this.Message;
                }
            }
            return this.m_simpleMessage;
        }
        ...
        public string GetStackTrace()
        {
            ...
            for (int c1 = 0; c1 < this.Callstack.Count; c1++)
            {
                var frame = this.Callstack[c1];
    ...
    public static class Logger
    {
        ...
        public static LinkedList<LogInfo> RecentMessages = new LinkedList<LogInfo>();
...
#endif
// #if !ENABLE_DEBUG
//                         if(severity==LogSeverity.Message) Debug.Log(message);
//                         else if(severity==LogSeverity.Warning) Debug.LogWarning(message);
//                         else if(severity==LogSeverity.Error) Debug.LogError(message);
// #endif
