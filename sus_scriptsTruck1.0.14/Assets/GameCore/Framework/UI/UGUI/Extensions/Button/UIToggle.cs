namespace GameCore.UI
{
    ...
    using ToggleGroup = UIToggleGroup;
    ...
    /// </remarks>
    [AddComponentMenu("UI/UIToggle", 31)]
    ...
    public class UIToggle : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        ...
        public GameObject[] onGroups;
        public GameObject[] offGroups;
...
//            graphic.CrossFadeAlpha(m_IsOn ? 1f : 0f, instant ? 0f : 0.1f, true);
            ...
            for(int i = 0; i < this.onGroups.Length; ++i)
            {
                this.onGroups[i].CustomSetActive(m_IsOn);
            }
            for (int i = 0; i < this.offGroups.Length; ++i)
            {
                this.offGroups[i].CustomSetActive(!m_IsOn);
            }
        }
