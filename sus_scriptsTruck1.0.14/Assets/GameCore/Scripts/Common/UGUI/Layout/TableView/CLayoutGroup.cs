...
public abstract class CLayoutGroup : UIBehaviour, ILayoutElement, ILayoutGroup
{
    /// <summary>
    /// 边间隔
    /// </summary>
    ...
    public virtual void CalculateLayoutInputHorizontal()
    {
        ...
        var toIgnoreList = CListPool<Component>.Get();
        ...
        CListPool<Component>.Release(toIgnoreList);
        m_Tracker.Clear();
    }
