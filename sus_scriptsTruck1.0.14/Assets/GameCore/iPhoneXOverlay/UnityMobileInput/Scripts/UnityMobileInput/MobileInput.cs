...
using UnityEngine;
    ...
    public class MobileInput : MonoBehaviour, IPlugin {
        ...
        /// </summary>
        public static Action<bool, float>  OnShowKeyboard = delegate { };

        /// <summary>
        /// Handler for PrepareDelegate
        /// </summary>
        public static Action OnPrepareKeyboard = delegate { };
            ...
            try {
                ...
                switch (code) {
                    ...
                    case KEYBOARD_ACTION:
                        ...
                        float height = 0;
#if UNITY_ANDROID
                        height = (float)response["height"] * Screen.height;
#elif UNITY_IOS
        ...
        public static void Execute (int id, JsonObject data) {
            ...
            using (AndroidJavaClass plugin = new AndroidJavaClass (string.Format (UnityMobileInputPlugins.ANDROID_CLASS_MASK, _instance.Name))) {
