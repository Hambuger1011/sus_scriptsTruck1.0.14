...
public class EndCapDemo : MonoBehaviour {
	...
	void Start () {
		...
		var line1 = new VectorLine("Arrow", null, new List<Vector2>(50), 30.0f, LineType.Continuous, Joins.Weld);
		...
		var line2 = new VectorLine("Arrow2", null, new List<Vector2>(50), 40.0f, LineType.Continuous, Joins.Weld);
		...
		var line3 = new VectorLine("Rounded", null, new List<Vector2>{new Vector2(.1f, .5f), new Vector2(.9f, .5f)}, 20.0f);
