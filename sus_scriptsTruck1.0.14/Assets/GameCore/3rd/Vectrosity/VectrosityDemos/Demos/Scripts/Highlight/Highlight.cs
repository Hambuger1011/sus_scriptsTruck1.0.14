...
public class Highlight : MonoBehaviour {
	...
	void Start () {
		...
		line = new VectorLine("Line", null, new List<Vector2>(), lineWidth);
		line.color = Color.green;
		line.capLength = lineWidth*.5f;
		energyLine = new VectorLine("Energy", null, new List<Vector2>(pointsInEnergyLine), null, energyLineWidth, LineType.Continuous);
		SetEnergyLinePoints();
	}
