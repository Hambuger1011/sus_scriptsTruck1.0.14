    ...
    public partial class VectorLine
    {
        ...
        GameObject m_go
        {
            get
            {
                ...
                {
                    return this.rectTransform.gameObject;
                }
                return null;
            }
        }
        ...
        public int drawStart
        {
            ...
            set
            {
                ...
                {   // No odd numbers for discrete lines
                    value++;
                }
        ...
        public int drawEnd
        {
            ...
            set
            {
                ...
                {   // No even numbers for discrete lines (except 0)
                    value++;
                }
        ...
        public int endPointsUpdate
        {
            ...
            set
            {
                if (m_lineType == LineType.Discrete)
                {
                    ...
                    { // No even numbers for discrete lines
                        value--;
                    }
                }
        ...
        public VectorLine(string name, RectTransform lineTrans,List<Vector3> points, float width)
        {
            m_points3 = points;
            SetupLine(name, lineTrans, null, width, LineType.Discrete, Joins.None, false);
        }
        public VectorLine(string name, RectTransform lineTrans, List<Vector3> points, Texture texture, float width)
        {
            m_points3 = points;
            SetupLine(name, lineTrans, texture, width, LineType.Discrete, Joins.None, false);
        }

        public VectorLine(string name, RectTransform lineTrans, List<Vector3> points, float width, LineType lineType)
        {
            m_points3 = points;
            SetupLine(name, lineTrans, null, width, lineType, Joins.None, false);
        }
        public VectorLine(string name, RectTransform lineTrans, List<Vector3> points, Texture texture, float width, LineType lineType)
        {
            m_points3 = points;
            SetupLine(name, lineTrans, texture, width, lineType, Joins.None, false);
        }

        public VectorLine(string name, RectTransform lineTrans, List<Vector3> points, float width, LineType lineType, Joins joins)
        {
            m_points3 = points;
            SetupLine(name, lineTrans, null, width, lineType, joins, false);
        }
        public VectorLine(string name, RectTransform lineTrans, List<Vector3> points, Texture texture, float width, LineType lineType, Joins joins)
        {
            m_points3 = points;
            SetupLine(name, lineTrans, texture, width, lineType, joins, false);
        }

        // Vector2 constructors
        public VectorLine(string name, RectTransform lineTrans, List<Vector2> points, float width)
        {
            m_points2 = points;
            SetupLine(name, lineTrans, null, width, LineType.Discrete, Joins.None, true);
        }
        public VectorLine(string name, RectTransform lineTrans, List<Vector2> points, Texture texture, float width)
        {
            m_points2 = points;
            SetupLine(name, lineTrans, texture, width, LineType.Discrete, Joins.None, true);
        }

        public VectorLine(string name, RectTransform lineTrans, List<Vector2> points, float width, LineType lineType)
        {
            m_points2 = points;
            SetupLine(name, lineTrans, null, width, lineType, Joins.None, true);
        }
        public VectorLine(string name, RectTransform lineTrans, List<Vector2> points, Texture texture, float width, LineType lineType)
        {
            m_points2 = points;
            SetupLine(name, lineTrans, texture, width, lineType, Joins.None, true);
        }

        public VectorLine(string name, RectTransform lineTrans, List<Vector2> points, float width, LineType lineType, Joins joins)
        {
            m_points2 = points;
            SetupLine(name, lineTrans, null, width, lineType, joins, true);
        }
        public VectorLine(string name, RectTransform lineTrans, List<Vector2> points, Texture texture, float width, LineType lineType, Joins joins)
        {
            m_points2 = points;
            SetupLine(name, lineTrans, texture, width, lineType, joins, true);
        }
        #endregion

        protected void SetupLine(string lineName, RectTransform lineTrans, Texture texture, float width, LineType lineType, Joins joins, bool use2D)
        {
            m_is2D = use2D;
            m_lineType = lineType;
            ...
            if(lineTrans == null)
            {
                ...
                m_rectTransform = go.AddComponent<RectTransform>();
                SetupTransform(m_rectTransform);
            }else
            {
                m_rectTransform = lineTrans;
            }
            m_texture = texture;
        ...
        private void SetupTriangles(int startVert)
        {
            ...
            {
                if (startVert >= 4)
                {   // Do fill for previous segment if this is added to already-existing segments
        ...
        {
            //throw new System.Exception("Dont Call this Method!!!");
        ...
        public static VectorLine SetLine(Color color, float time, params Vector2[] points)
        {
            ...
            var line = new VectorLine("Line", null, new List<Vector2>(points), null, 1.0f, LineType.Continuous, Joins.None);
            line.color = color;
            if (time > 0.0f)
            {
        ...
        public static VectorLine SetLine(Color color, float time, params Vector3[] points)
        {
            ...
            var line = new VectorLine("SetLine", null, new List<Vector3>(points), null, 1.0f, LineType.Continuous, Joins.None);
            line.color = color;
            if (time > 0.0f)
            {
                lineManager.DisableLine(line, time);
        ...
        public static VectorLine SetLine3D(Color color, float time, params Vector3[] points)
        {
            ...
            var line = new VectorLine("SetLine3D", null, new List<Vector3>(points), null, 1.0f, LineType.Continuous, Joins.None);
            line.color = color;
        ...
        {
            var line = new VectorLine("SetRay", null, new List<Vector3>(new Vector3[] { origin, new Ray(origin, direction).GetPoint(direction.magnitude) }), null, 1.0f, LineType.Continuous, Joins.None);
            line.color = color;
            if (time > 0.0f)
            {
                lineManager.DisableLine(line, time);
        ...
        {
            var line = new VectorLine("SetRay3D", null, new List<Vector3>(new Vector3[] { origin, new Ray(origin, direction).GetPoint(direction.magnitude) }), null, 1.0f, LineType.Continuous, Joins.None);
            line.color = color;
            line.Draw3DAuto(time);
            return line;
        }
        ...
        public void Draw()
        {
            ...
            if (m_vectorObject == null)
            {   // In case the reference is lost in the editor
                m_vectorObject = m_go.GetComponent<VectorObject2D>();
            }
        ...
        private void Line2D(int start, int end, Matrix4x4 thisMatrix, bool useTransformMatrix)
        {
            ...
            if (m_joins == Joins.Weld)
            {
                ...
                {
                    if ((end & 1) == 0)
                    {   // end should be odd for discrete lines
                        end--;
                    }
        ...
        private void Line3D(int start, int end, Matrix4x4 thisMatrix, bool useTransformMatrix)
        {
            ...
            { // Only weld if there's more than one segment
                if (m_lineType == LineType.Continuous)
                {
        ...
        private void SetIntersectionPoint(int p1, int p2, int p3, int p4)
        {
            ...
            {   // Sometimes nearly parallel lines have errors, so just average the points together
                if (Mathf.Abs(l1b.x - l2a.x) < .005f && Mathf.Abs(l1b.y - l2a.y) < .005f)
                {   // But only if the points are mostly the same
