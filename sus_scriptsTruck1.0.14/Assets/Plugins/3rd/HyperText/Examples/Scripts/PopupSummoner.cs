...
namespace Candlelight.UI.HyperTextDemo
{
	public class PopupSummoner : MonoBehaviour
	{
        ...
        private void Awake()
        {
            HyperTextUtils.RegisterLoadQuad(OnLoadQuad);
        }
        ...
        {
            Debug.LogError("click link:index=" + info.Index + ", class=" + info.ClassName + ",href=" + info.Name);
        }

        private HyperTextStyles.Quad OnLoadQuad(string className)
        {
