...
namespace Candlelight.UI
{
	...
	public class HyperTextStylesEditor : Editor
	{
		...
		/// </summary>
		//private Dictionary<HyperTextStyles.Quad, HyperTextStyles> m_InheritedQuads = new Dictionary<HyperTextStyles.Quad, HyperTextStyles>();
		/// <summary>
		...
		/// </summary>
		//private Dictionary <int, CustomStyleGUIContent> m_QuadGUIContents = new Dictionary<int, CustomStyleGUIContent>();
		/// <summary>
		...
		private void OnEnable()
		{
			...
			//m_QuadStyles = new ReorderableList(this.serializedObject, this.serializedObject.FindProperty("m_QuadStyles"));
		...
		private void UpdateCustomStyleGUIContents()
		{
			...
			using (
				ListPool<HyperTextStyles.LinkSubclass>.Scope links = new ListPool<HyperTextStyles.LinkSubclass>.Scope()
			)
			{
				...
				//using (ListPool<HyperTextStyles.Quad>.Scope quads = new ListPool<HyperTextStyles.Quad>.Scope())
				//{
			...
			using (ListPool<HyperTextStyles.Text>.Scope tags = new ListPool<HyperTextStyles.Text>.Scope())
			{
