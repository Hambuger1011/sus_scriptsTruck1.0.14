...
#endif
{
    ...
    public enum PBXSourceTree
    {
        ...
        Group,      // The path is relative to the folder it's in. This enum is used only publicly,
    ...
    public class PBXProject
    {
        ...
        // of PBXProjectData
        public PBXContainerItemProxySection containerItems { get { return m_Data.containerItems; } }
        public PBXReferenceProxySection references         { get { return m_Data.references; } }
        public PBXSourcesBuildPhaseSection sources         { get { return m_Data.sources; } }
        public PBXFrameworksBuildPhaseSection frameworks   { get { return m_Data.frameworks; } }
        public PBXResourcesBuildPhaseSection resources     { get { return m_Data.resources; } }
        public PBXCopyFilesBuildPhaseSection copyFiles     { get { return m_Data.copyFiles; } }
        public PBXShellScriptBuildPhaseSection shellScripts { get { return m_Data.shellScripts; } }
        public PBXNativeTargetSection nativeTargets        { get { return m_Data.nativeTargets; } }
        public PBXTargetDependencySection targetDependencies { get { return m_Data.targetDependencies; } }
        public PBXVariantGroupSection variantGroups        { get { return m_Data.variantGroups; } }
        public XCBuildConfigurationSection buildConfigs    { get { return m_Data.buildConfigs; } }
        public XCConfigurationListSection buildConfigLists { get { return m_Data.buildConfigLists; } }
        public PBXProjectSection project                   { get { return m_Data.project; } }

        public PBXBuildFileData BuildFilesGet(string guid) { return m_Data.BuildFilesGet(guid); }
        public void BuildFilesAdd(string targetGuid, PBXBuildFileData buildFile) { m_Data.BuildFilesAdd(targetGuid, buildFile); }
        public void BuildFilesRemove(string targetGuid, string fileGuid) { m_Data.BuildFilesRemove(targetGuid, fileGuid); }
        public PBXBuildFileData BuildFilesGetForSourceFile(string targetGuid, string fileGuid) { return m_Data.BuildFilesGetForSourceFile(targetGuid, fileGuid); }
        public IEnumerable<PBXBuildFileData> BuildFilesGetAll() { return m_Data.BuildFilesGetAll(); }
        public void FileRefsAdd(string realPath, string projectPath, PBXGroupData parent, PBXFileReferenceData fileRef) { m_Data.FileRefsAdd(realPath, projectPath, parent, fileRef); }
        public PBXFileReferenceData FileRefsGet(string guid) { return m_Data.FileRefsGet(guid); }
        public PBXFileReferenceData FileRefsGetByRealPath(string path, PBXSourceTree sourceTree) { return m_Data.FileRefsGetByRealPath(path, sourceTree); }
        public PBXFileReferenceData FileRefsGetByProjectPath(string path) { return m_Data.FileRefsGetByProjectPath(path); }
        public void FileRefsRemove(string guid) { m_Data.FileRefsRemove(guid); }
        public PBXGroupData GroupsGet(string guid) { return m_Data.GroupsGet(guid); }
        public PBXGroupData GroupsGetByChild(string childGuid) { return m_Data.GroupsGetByChild(childGuid); }
        public PBXGroupData GroupsGetMainGroup() { return m_Data.GroupsGetMainGroup(); }
        public PBXGroupData GroupsGetByProjectPath(string sourceGroup) { return m_Data.GroupsGetByProjectPath(sourceGroup); }
        public void GroupsAdd(string projectPath, PBXGroupData parent, PBXGroupData gr) { m_Data.GroupsAdd(projectPath, parent, gr); }
        public void GroupsAddDuplicate(PBXGroupData gr) { m_Data.GroupsAddDuplicate(gr); }
        public void GroupsRemove(string guid) { m_Data.GroupsRemove(guid); }
        public FileGUIDListBase BuildSectionAny(PBXNativeTargetData target, string path, bool isFolderRef) { return m_Data.BuildSectionAny(target, path, isFolderRef); }
        public FileGUIDListBase BuildSectionAny(string sectionGuid) { return m_Data.BuildSectionAny(sectionGuid); }
        ...
        public void RemoveFilesByProjectPathRecursive(string projectPath)
        {
            projectPath = PBXPath.FixSlashes(projectPath);
        ...
        public List<string> GetGroupChildrenFiles(string projectPath)
        {
            projectPath = PBXPath.FixSlashes(projectPath);
            PBXGroupData gr = GroupsGetByProjectPath(projectPath);
            if (gr == null)
        ...
        public HashSet<string> GetGroupChildrenFilesRefs(string projectPath)
        {
            projectPath = PBXPath.FixSlashes(projectPath);
            PBXGroupData gr = GroupsGetByProjectPath(projectPath);
            if (gr == null)
        ...
        public HashSet<string> GetFileRefsByProjectPaths(IEnumerable<string> paths)
        {
        ...
        public PBXGroupData CreateSourceGroup(string sourceGroup)
        {
        ...
        public string GetConfigListForTarget(string targetGuid)
        {
        ...
        public PBXBuildFileData FindFrameworkByFileGuid(PBXCopyFilesBuildPhaseData phase, string fileGuid)
        {
        ...
        public void RemoveBuildProperty(string targetGuid, string name)
        {
            foreach (string guid in buildConfigLists[GetConfigListForTarget(targetGuid)].buildConfigs)
                RemoveBuildPropertyForConfig(guid, name);
        }
        public void RemoveBuildProperty(IEnumerable<string> targetGuids, string name)
        {
            foreach (string t in targetGuids)
                RemoveBuildProperty(t, name);
        }
        public void RemoveBuildPropertyForConfig(string configGuid, string name)
        {
            buildConfigs[configGuid].RemoveProperty(name);
        }
        public void RemoveBuildPropertyForConfig(IEnumerable<string> configGuids, string name)
        {
            foreach (string guid in configGuids)
                RemoveBuildPropertyForConfig(guid, name);
        }

        public void RemoveBuildPropertyValueList(string targetGuid, string name, IEnumerable<string> valueList)
        {
            foreach (string guid in buildConfigLists[GetConfigListForTarget(targetGuid)].buildConfigs)
                RemoveBuildPropertyValueListForConfig(guid, name, valueList);
        }
        public void RemoveBuildPropertyValueList(IEnumerable<string> targetGuids, string name, IEnumerable<string> valueList)
        {
            foreach (string t in targetGuids)
                RemoveBuildPropertyValueList(t, name, valueList);
        }
        public void RemoveBuildPropertyValueListForConfig(string configGuid, string name, IEnumerable<string> valueList)
        {
            buildConfigs[configGuid].RemovePropertyValueList(name, valueList);
        }
        public void RemoveBuildPropertyValueListForConfig(IEnumerable<string> configGuids, string name, IEnumerable<string> valueList)
        {
            foreach (string guid in configGuids)
                RemoveBuildPropertyValueListForConfig(guid, name, valueList);
        }
        ...
        public string ShellScriptByName(string targetGuid, string name)
        {
        ...
        public PBXProjectObjectData GetProjectpublic()
        {
