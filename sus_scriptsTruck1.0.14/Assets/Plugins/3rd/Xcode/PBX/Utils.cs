...
#endif
{
    ...
    public class FileTypeUtils
    {
        ...
        public static bool IsFileTypeExplicit(string ext)
        {
            ext = TrimExtension(ext);
        ...
        public static PBXSourceTree ParseSourceTree(string tree)
        {
        ...
        public static List<PBXSourceTree> AllAbsoluteSourceTrees()
        {
