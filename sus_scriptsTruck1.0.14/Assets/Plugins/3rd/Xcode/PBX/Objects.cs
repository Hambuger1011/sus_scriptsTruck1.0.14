...
#endif
{
    public class PBXObjectData
    {   
        public string guid;
        protected PBXElementDict m_Properties = new PBXElementDict();
        
        public void SetPropertiesWhenSerializing(PBXElementDict props)
        {
            m_Properties = props;
        }
        
        public PBXElementDict GetPropertiesWhenSerializing() 
        { 
            return m_Properties; 
        }

        /*  Returns the public properties dictionary which the user may manipulate directly.
        ...
        */
        public PBXElementDict GetPropertiesRaw()
        {
            UpdateProps();
            return m_Properties;
        }
        ...
        public virtual PropertyCommentChecker checker { get { return checkerData; } }
        public virtual bool shouldCompact { get { return false; } }
    ...
    public class PBXBuildFileData : PBXObjectData
    {
        ...
        public override PropertyCommentChecker checker { get { return checkerData; } }
        public override bool shouldCompact { get { return true; } }
    ...
    public class PBXFileReferenceData : PBXObjectData
    {
        string m_Path = null;
    ...
    public class GUIDList : IEnumerable<string>
    {
    ...
    public class XCConfigurationListData : PBXObjectData
    {
    ...
    public class PBXGroupData : PBXObjectData
    {
    ...
    public class PBXVariantGroupData : PBXGroupData
    {
    }

    public class PBXNativeTargetData : PBXObjectData
    {
    ...
    public class FileGUIDListBase : PBXObjectData
    {
    ...
    public class PBXSourcesBuildPhaseData : FileGUIDListBase
    {
    ...
    public class PBXFrameworksBuildPhaseData : FileGUIDListBase
    {
    ...
    public class PBXResourcesBuildPhaseData : FileGUIDListBase
    {
    ...
    public class PBXCopyFilesBuildPhaseData : FileGUIDListBase
    {
        private static PropertyCommentChecker checkerData = new PropertyCommentChecker(new string[]{
            "files/*",
        });
    ...
    public class PBXShellScriptBuildPhaseData : FileGUIDListBase
    {
        public string name;
    ...
    public class BuildConfigEntryData
    {
        public string name;
    ...
    public class XCBuildConfigurationData : PBXObjectData
    {
    ...
    public class PBXContainerItemProxyData : PBXObjectData
    {
        private static PropertyCommentChecker checkerData = new PropertyCommentChecker(new string[]{
            "containerPortal/*"
        });
    ...
    public class PBXReferenceProxyData : PBXObjectData
    {
        private static PropertyCommentChecker checkerData = new PropertyCommentChecker(new string[]{
            "remoteRef/*"
        });
    ...
    public class PBXTargetDependencyData : PBXObjectData
    {
        private static PropertyCommentChecker checkerData = new PropertyCommentChecker(new string[]{
            "target/*",
            "targetProxy/*"
    ...
    public class PBXProjectObjectData : PBXObjectData
    {
        private static PropertyCommentChecker checkerData = new PropertyCommentChecker(new string[]{
            "buildConfigurationList/*",
            "mainGroup/*",
