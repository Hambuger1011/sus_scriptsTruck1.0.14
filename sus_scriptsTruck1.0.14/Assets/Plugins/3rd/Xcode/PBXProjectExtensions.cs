...
#endif
{
    ...
    */
    public static class PBXProjectExtensions
    {
        ...
        public class FlagList : List<KeyValuePair<string, string>>
        {
        ...
        public static FlagList appExtensionReleaseBuildFlags = new FlagList
        {
        ...
        public static FlagList appExtensionDebugBuildFlags = new FlagList
        {
            // { "INFOPLIST_FILE", <path/to/info.plist> },
            { "LD_RUNPATH_SEARCH_PATHS", "$(inherited)" },
            { "LD_RUNPATH_SEARCH_PATHS", "@executable_path/Frameworks" },
        ...
        public static FlagList watchExtensionReleaseBuildFlags = new FlagList
        {
        ...
        public static FlagList watchExtensionDebugBuildFlags = new FlagList
        {
            { "ASSETCATALOG_COMPILER_COMPLICATION_NAME", "Complication" },
            { "CLANG_ANALYZER_NONNULL", "YES" },
            { "CLANG_WARN_DOCUMENTATION_COMMENTS", "YES" },
        ...
        public static FlagList watchAppReleaseBuildFlags = new FlagList
        {
        ...
        public static FlagList watchAppDebugBuildFlags = new FlagList
        {
            { "ASSETCATALOG_COMPILER_APPICON_NAME", "AppIcon" },
            { "CLANG_ANALYZER_NONNULL", "YES" },
            { "CLANG_WARN_DOCUMENTATION_COMMENTS", "YES" },
        ...
        */
        public static void AddExternalLibraryDependency(this PBXProject proj, string targetGuid, string filename, string remoteFileGuid, string projectPath,
                                                          string remoteInfo)
        {
