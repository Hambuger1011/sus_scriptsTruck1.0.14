...
#endif
{
	public class DeviceTypeRequirement
    {
	...
	public class GraphicsRequirement
    {
    ...
    public class SizeClassRequirement
    {
    ...
    public abstract class AssetCatalogItem
    {
    ...
    public class AssetFolder : AssetCatalogItem
    {
        ...
        public AssetFolder(string parentPath, string name, string authorId) : base(name, authorId)
        {
            if (name != null)
    ...
    public abstract class AssetCatalogItemWithVariants : AssetCatalogItem
    {
    ...
    public class AssetDataSet : AssetCatalogItemWithVariants
    {
        protected class DataSetVariant : VariantData
        {
            public string id;
        ...
        public AssetDataSet(string parentPath, string name, string authorId) : base(name, authorId)
        {
    ...
    public class AssetImageSet : AssetCatalogItemWithVariants
    {
        public AssetImageSet(string assetCatalogPath, string name, string authorId) : base(name, authorId)
        {
            m_Path = Path.Combine(assetCatalogPath, name + ".imageset");
        }

        protected class ImageSetVariant : VariantData
        {
    ...
    */
    public class AssetImageStackLayer : AssetCatalogItem
    {
        public AssetImageStackLayer(string assetCatalogPath, string name, string authorId) : base(name, authorId)
        {
    ...
    public class AssetImageStack : AssetCatalogItem
    {
        List<AssetImageStackLayer> m_Layers = new List<AssetImageStackLayer>();

        public AssetImageStack(string assetCatalogPath, string name, string authorId) : base(name, authorId)
        {
    ...
    public class AssetBrandAssetGroup : AssetCatalogItem
    {
        public class AssetBrandAssetItem
        {
            public string idiom = null;
            public string role = null;
            public int width, height;
            public AssetCatalogItem item = null;
            
        }

        List<AssetBrandAssetItem> m_Items = new List<AssetBrandAssetItem>();
        
        public AssetBrandAssetGroup(string assetCatalogPath, string name, string authorId) : base(name, authorId)
        {
