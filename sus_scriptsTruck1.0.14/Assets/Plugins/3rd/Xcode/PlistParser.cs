...
#endif
{
    ...
    public class PlistDocument
    {
        ...
        public static XDocument ParseXmlNoDtd(string text)
        {
        ...
        // LINQ serializes XML DTD declaration with an explicit empty 'public subset'
        ...
        public static string CleanDtdToString(XDocument doc, XDocumentType documentType)
        {
        ...
        public static string CleanDtdToString(XDocument doc)
        {
