...
local ChangeSceneByWhiteComponent = Class("ChangeSceneByWhiteComponent", Base)


--收集所用到的资源
function ChangeSceneByWhiteComponent:CollectRes(resTable)
    Base.CollectRes(self,resTable)
    resTable["Assets/Bundle/UI/BookReading/ChangeSceneMask.prefab"] = BookResType.UIRes
end


function ChangeSceneByWhiteComponent:Clean()
	Base.Clean(self)
end


function ChangeSceneByWhiteComponent:Play()
    ...
    maskImage.color = core.Color.New(1,1,1,0)
...
return ChangeSceneByWhiteComponent