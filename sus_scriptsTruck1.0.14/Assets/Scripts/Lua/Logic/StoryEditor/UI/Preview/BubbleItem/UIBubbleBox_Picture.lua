...
function Item:__init(transform)
    ...
    self.btnPicture = self.uiBinding:Get('imgPicture',  typeof(logic.cs.UITweenButton))
    ...
    self.btnPicture.onClick:AddListener(function()
...
function UIBubbleBox_Picture:__init(uiItem)
    ...
    for _,item in pairs(self.boxes) do
