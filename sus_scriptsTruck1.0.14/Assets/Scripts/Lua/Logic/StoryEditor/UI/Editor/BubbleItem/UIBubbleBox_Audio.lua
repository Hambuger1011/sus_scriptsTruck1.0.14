...
function Item:__init(transform)
    ...
    self.headIcon = get(transform,'head/icon',typeof(logic.cs.Image))
...
function UIBubbleBox_Audio:SetData(bubbleData)
    ...
    self:SetBoxType(storyDetial.roleTable:GetDialogType(bubbleData.storyDetial))
