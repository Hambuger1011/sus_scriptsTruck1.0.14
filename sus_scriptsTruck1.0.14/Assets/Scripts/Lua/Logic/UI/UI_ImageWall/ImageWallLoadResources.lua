...
function ImageWallLoadResources:StartLoadResources()
    ...
    useResTable["Assets/Bundle/ImageWall/male/body/body_SkeletonData.asset"] = BookResType.UIRes
    useResTable["Assets/Bundle/ImageWall/male/clothes/clothes1_SkeletonData.asset"] = BookResType.UIRes
    useResTable["Assets/Bundle/ImageWall/male/head/b/head1_SkeletonData.asset"] = BookResType.UIRes
    useResTable["Assets/Bundle/ImageWall/male/hair/hair1_SkeletonData.asset"] = BookResType.UIRes
...
function ImageWallLoadResources:Download(abResType,assetName,bookResType,callback)
    local asset = nil
