...
function UIActivityBannerForm:OnInitView()
    ...
    self.Banner1Rect=self.ActivityBanner1.gameObject:GetComponent("RectTransform");
    ...
    self.Banner2Rect=self.ActivityBanner2.gameObject:GetComponent("RectTransform");
...
function UIActivityBannerForm:Anima()
    ...
    local _index=self.AllCount%3;
    if(_index==0)then _index=3; end
...
function UIActivityBannerForm:SetView(state)
    ...
    elseif(state== EnumActivity.FreeKey)then   --全书免费
        ...
        self.Titile1.text="Appointment ceremony!"
...
function UIActivityBannerForm:SetView2(state)
    ...
    elseif(state== EnumActivity.FreeKey)then   --全书免费
        ...
        self.Titile2.text="Appointment ceremony!"
