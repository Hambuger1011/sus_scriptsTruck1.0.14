...
function ChatItem:SetItemData(itemData,itemIndex)
    ...
    --显示头像
    GameHelper.luaShowDressUpForm(itemData.avatar,self.HeadIcon,DressUp.Avatar,1001);
    --加载头像框
    GameHelper.luaShowDressUpForm(itemData.avatar_frame,self.HeadFrame,DressUp.AvatarFrame,2001);
